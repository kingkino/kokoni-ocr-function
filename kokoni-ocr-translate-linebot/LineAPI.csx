...
static async Task<Stream> GetLineContents(string messageId)
{
    ...
    {
        //　認証ヘッダーを追加
        getContentsClient.DefaultRequestHeaders.Add("Authorization", $"Bearer {ConfigurationManager.AppSettings["ChannelAccessTokenOCRTranslate"]}");
...
{    
    ...
    using (var client = new HttpClient())
    {
        ...
        //　認証ヘッダーを追加
        client.DefaultRequestHeaders.Add("Authorization", $"Bearer {ConfigurationManager.AppSettings["ChannelAccessTokenOCRTranslate"]}");
